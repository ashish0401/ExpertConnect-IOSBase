...
struct CosmosLocalizedRating {
    ...
    static var ratingTranslation: String {
        let languages = preferredLanguages(preferredLocales: NSLocale.preferredLanguages)
        return ratingInPreferredLanguage(preferredLanguages: languages)
    }
    ...
    static func translationInPreferredLanguage(preferredLanguages: [String],
        ...
        for language in preferredLanguages {
            if let translatedText = translation(language: language) {
    ...
    static func ratingInPreferredLanguage(preferredLanguages: [String]) -> String {
        return translationInPreferredLanguage(preferredLanguages: preferredLanguages,
