...
class BrowseExpertsVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //expertiseStaticHeight = (cell.expertiseStaticLabel.text?.heightWithConstrainedWidth(width: expertiseStaticWidth, font: UIFont(name: "Raleway-Light", size: 14)!))!
        ...
        //coachingStaticHeight = (cell.coachingStaticLabel.text?.heightWithConstrainedWidth(width: coachingStaticWidth, font: UIFont(name: "Raleway-Light", size: 14)!))!
        ...
        //locationStaticHeight = (cell.locationStaticLabel.text?.heightWithConstrainedWidth(width: locationStaticWidth, font: UIFont(name: "Raleway-Light", size: 14)!))!
...
//            self.displayErrorMessage(message: data.message)
    ...
    func onRequSendestSucceeded(data: SendRequestOutputDomainModel) {
        self.dismissProgress()
        if data.status {
            //alertView.containerView = createContainerView(requestSuccessMessage: data.message)
...
//            self.userId = UserDefaults.standard.value(forKey: "UserId") as! String
//            self.location = UserDefaults.standard.value(forKey: "Location") as! String
//            let BrowseExpertListModel = BrowseExpertListDomainModel.init(userId: self.userId, location: "Pune", offset:"0" , limit: "10")
//            let APIDataManager : BrowseExpertListProtocols = BrowseExpertListApiDataManager()
//            APIDataManager.getBrowseExpertList(data: BrowseExpertListModel, callback:{(result) in
//                print("result : ", result)
//                switch result {
